...
const INIT_EMPLOYEES = [
  { id: "e1",  name: "Ahmad Bin Hassan",             employeeNumber: "SB001", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "001" },
  { id: "e2",  name: "Siti Nurhaliza Binte Azman",   employeeNumber: "SB002", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "002" },
  { id: "e3",  name: "Raj Kumar Suppiah",             employeeNumber: "SB003", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "003" },
  { id: "e4",  name: "Wong Wei Liang",                employeeNumber: "SB004", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "004" },
  { id: "e5",  name: "Priya Sundaram",                employeeNumber: "SB005", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "005" },
  { id: "e6",  name: "Tan Ah Kow",                   employeeNumber: "SB006", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "006" },
  { id: "e7",  name: "Nurul Ain Binte Ali",           employeeNumber: "SB007", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "007" },
  { id: "e8",  name: "David Lim Chin Huat",           employeeNumber: "SB008", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "008" },
  { id: "e9",  name: "Sarah Chen Mei Ling",           employeeNumber: "SB009", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "009" },
  { id: "e10", name: "Mohammed Faizal Bin Ismail",    employeeNumber: "SB010", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "010" },
  { id: "e11", name: "Lee Boon Heng",                 employeeNumber: "SB011", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "011" },
  { id: "e12", name: "Kavitha Nair",                  employeeNumber: "SB012", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "012" },
  { id: "e13", name: "Zainudin Bin Nordin",           employeeNumber: "SB013", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "013" },
  { id: "e14", name: "Grace Loh Pei Shan",            employeeNumber: "SB014", email: "", pax: 1, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "014" },
  { id: "e15", name: "Suresh Pillai",                 employeeNumber: "SB015", email: "", pax: 2, drawEligible: true, tableId: null, rsvpStatus: "pending", drawNumber: "015" },
];
...
// Get next sequential draw number from all employees
// Returns formatted string like "016"
const getNextDrawNumber = (employees) => {
  const existingNums = employees
    .map(e => {
      const n = parseInt((e.drawNumber || "0").replace(/\D/g, ""), 10);
      return isNaN(n) ? 0 : n;
    })
    .filter(n => n > 0);
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "#EDE4D3" }}>
                    {["Draw #", "Name", "Employee No.", "Email", "Pax", "RSVP", "Table", "Draw Eligible", "Actions"].map(h => (
...
function DrawAdmin({ employees, setEmployees, prizes, setPrizes, winners, setWinners, eventInfo, onLogout, setPage }) {
  ...
  const spinTicker = (pool, duration, onDone) => {
    ...
    const fastPhase = () => {
      ...
      setSpinName(display);
      broadcast({ type: "SPIN_NAME", payload: display });
